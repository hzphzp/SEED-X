...
# change: OUTPUT_PATH, save_steps, resume_from_checkpoint, resume_steps
...
torchrun --nproc_per_node=8 \
    ...
    --eval_steps 10 \
    --resume_steps 9000 \
    --resume_from_checkpoint /mnt/wfs/mmshanghai8wfssh/project_mm-base-vision-tj/huangzp/training_logs/SEED-X/train_seed_x_detokenizer_qwen_sdxl_ftunet_bs64_lr1e-4_wd5e-2_step20000/checkpoint-9000 # 不要最后这个 pytorch_model/mp_rank_00_model_states.pt
